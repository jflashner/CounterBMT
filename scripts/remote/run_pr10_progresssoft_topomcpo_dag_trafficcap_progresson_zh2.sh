...
EXP_NAME="${EXP_NAME:-pr10_1_top500_actualwall_progresssoft_topomcpo_gtmix_trafficcap5_progresson_4gpu_h200_run1}"
...
cmd=(
  ...
  --config-name
  motion_forward_sdc_semantic_only_progresssoft_topomcpo_dag_trafficcap_progresson.yaml
  exp_name="$EXP_NAME"
