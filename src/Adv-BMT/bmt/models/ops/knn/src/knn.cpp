...
void knn_batch_mlogk_half(at::Tensor xyz_tensor, at::Tensor query_xyz_tensor, at::Tensor batch_idxs_tensor, at::Tensor query_batch_offsets_tensor, at::Tensor idx_tensor, int n, int m, int k){
    ...
    const at::BFloat16 *query_xyz = query_xyz_tensor.data_ptr<at::BFloat16>();
    const at::BFloat16 *xyz = xyz_tensor.data_ptr<at::BFloat16>();
    const int *batch_idxs = batch_idxs_tensor.data_ptr<int>();
    const int *query_batch_offsets = query_batch_offsets_tensor.data_ptr<int>();
    int *idx = idx_tensor.data_ptr<int>();
    ...
    knn_batch_mlogk_cuda_half(n, m, k, xyz, query_xyz, batch_idxs, query_batch_offsets, idx, stream);
}
...
void knn_batch_mlogk_half_fp16(at::Tensor xyz_tensor, at::Tensor query_xyz_tensor, at::Tensor batch_idxs_tensor, at::Tensor query_batch_offsets_tensor, at::Tensor idx_tensor, int n, int m, int k){
    ...
    const at::Half *query_xyz = query_xyz_tensor.data_ptr<at::Half>();
    ...
    knn_batch_mlogk_cuda_half_fp16(n, m, k, xyz, query_xyz, batch_idxs, query_batch_offsets, idx, stream);
}
