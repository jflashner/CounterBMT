...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("knn_batch_mlogk_half", &knn_batch_mlogk_half, "knn_batch_mlogk_half");
    m.def("knn_batch_mlogk_half_fp16", &knn_batch_mlogk_half_fp16, "knn_batch_mlogk_half_fp16");
}
