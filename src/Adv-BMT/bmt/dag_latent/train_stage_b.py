"""Stage-B training entrypoint for additive DAG-latent legacy Adv-BMT.
...
- the datamodule attaches cache-backed DAG tensors to each batch
- Stage B can freeze non-DAG parameters while fitting DAG adapters
"""
...
@hydra.main(
    ...
    config_name="0202_midgpt_dag_stage_b.yaml",
)
def main(config):
