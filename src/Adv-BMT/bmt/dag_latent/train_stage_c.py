"""Stage-C training entrypoint for additive DAG-latent legacy Adv-BMT.

This keeps the legacy training stack as intact as possible and only layers in:
- the additive DAG-latent Lightning wrapper
- the additive DAG-cache datamodule
- Stage-C optimizer grouping for joint finetuning
"""
...
@hydra.main(
    ...
    config_name="0202_midgpt_dag_stage_c.yaml",
)
def main(config):
